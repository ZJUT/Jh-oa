...
<div class="crumb">
	<div class="addproduct-title">编辑产品</div>
...
<div style="position:relative;">
	...
	<form name="addproductForm" id="addproductForm" action="action/product/modify" method="post">
	<div class="formItem">
	...
	<div class="formItem">
		<input type="submit" value="编辑" class="bt bt-editproduct" />
	</div>
	</form>
	</div>
</div>
