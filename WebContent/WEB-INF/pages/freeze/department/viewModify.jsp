...
<div class="crumb">
	<div class="adddepartment-title">编辑部门</div>
...
<form name="modifydepartmentForm" id="modifydepartmentForm" action="action/department/modify" method="post">
<div class="formItem">
...
<div class="formItem">
	<input type="submit" value="完成编辑" class="bt bt-adddepartment" />
</div>
</form>
</div>
