...
<div class="crumb">
	<div class="addoperator-title">添加新操作</div>
...
<form name="addoperatorForm" id="addoperatorForm" action="action/operator/add" method="post">
<div class="formItem">
...
<div class="formItem">
	<input type="submit" value="添加" class="bt bt-addoperator" />
</div>
</form>
</div>
