...
<div class="crumb">
	<div class="addrole-title">编辑角色</div>
...
<form name="modifyroleForm" id="modifyroleForm" action="action/role/modify" method="post">
<div class="formItem">
...
<div class="formItem">
	<input type="submit" value="完成编辑" class="bt bt-addrole" />
</div>
</form>
</div>
