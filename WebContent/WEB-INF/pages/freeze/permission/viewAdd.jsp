...
<div class="crumb">
	<div class="addpermission-title">添加权限</div>
...
<form name="addpermissionForm" id="addpermissionForm" action="action/permission/add" method="post">
<div class="formItem">
...
<div class="formItem">
	<input type="submit" value="添加" class="bt bt-addpermission" />
</div>
</form>
</div>
