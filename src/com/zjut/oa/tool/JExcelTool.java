...
public class JExcelTool {
	...
	public static void exportUserToOutputStream(String savefilename,
		...
		try {
			...
			Label label_30 = new Label(3, 0, "邮箱");
			Label label_40 = new Label(4, 0, "短号");
			Label label_50 = new Label(5, 0, "手机");
			Label label_60 = new Label(6, 0, "所在校区");
			Label label_70 = new Label(7, 0, "所在学院");
			Label label_80 = new Label(8, 0, "专业班级");
			Label label_90 = new Label(9, 0, "宿舍");
			Label label_100 = new Label(10, 0, "状态");
			Label label_110 = new Label(11, 0, "添加时间");
			Label label_120 = new Label(12, 0, "编辑时间");
			...
			for (int i = 0, len = utList.size(); i < len; i++) {
				...
				Label label_email = new Label(3, i + 1, email);
				Label label_cornet = new Label(4, i + 1, cornet);
				Label label_telephone = new Label(5, i + 1, telephone);
				Label label_location = new Label(6, i + 1, location);
				Label label_academyname = new Label(7, i + 1, academyname);
				Label label_major = new Label(8, i + 1, major);
				Label label_dormitory = new Label(9, i + 1, dormitory);
				Label label_islock = new Label(10, i + 1, islock);
				Label label_addtime = new Label(11, i + 1, addtime);
				Label label_modifytime = new Label(12, i + 1, modifytime);
